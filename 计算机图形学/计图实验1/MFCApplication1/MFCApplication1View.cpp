...
BEGIN_MESSAGE_MAP(CMFCApplication1View, CView)
	...
	ON_WM_CONTEXTMENU()
	ON_WM_RBUTTONUP()
	ON_COMMAND(ID_32771, &CMFCApplication1View::OnTriangle)
	ON_COMMAND(ID_32772, &CMFCApplication1View::OnAnimation)
	ON_COMMAND(ID_32773, &CMFCApplication1View::OnBall)
END_MESSAGE_MAP()
...
void CMFCApplication1View::OnTriangle()
{
	// TODO: 在此添加命令处理程序代码
	CDC* pDC = GetDC();
...
void CMFCApplication1View::OnAnimation()
{
	// TODO: 在此添加命令处理程序代码
	CDC* pDC = GetDC();
	int left, right;
...
void CMFCApplication1View::OnBall()
{
	// TODO: 在此添加命令处理程序代码
	CDC* pDC = GetDC();
	int x, y, r;
